...
<script>
    $(document).ready(function(){
		$("ul.sparow_table_legend").css('display','none');	
		$("p.toggle a").click(function(){ 
			$("ul.sparow_table_legend").toggle(); return false;	
		});      
	    ...
	    <div class="yui-u first"> 
	        <?php
				  if ($site_name=strip_tags(variable_get('site_name',''))) {
					...
					print "<h1><a href=\"".check_url($front_page)."\" title=\"".$site_name."\"  >".$site_name."</a> / ".$title."&nbsp;&#8212; automotive&nbsp;journal.</h1>";
				  }
