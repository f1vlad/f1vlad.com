...
<?$ret=rand(100,500);if($ret>300 && $ret<400){?><a href="http://github.com/f1vlad" style=""><img alt="Fork me on GitHub" src="http://s3.amazonaws.com/github/ribbons/forkme_right_orange_ff7600.png" style="opacity:.75;border: 0pt none ; position: absolute; top: 0pt; right: 0pt;"/></a><?}?>
<div id="yui-main" class="yui-t4"> 

<h1>
	<a class="logo" title="f1vlad.com" href="/">f1vlad.com</a>
	<span class="t"><?php if ($title): print $title; endif; ?></span>
	<span class="i">
		<?php if ($hdrtext): print $hdrtext; else: print "x"; endif; ?>
	</span>
</h1>
<h2 class="ico">icon</h2>
<h3 class="author"><a href="http://f1vlad.com"><?php if ($site_slogan=strip_tags(variable_get('site_slogan',''))) {print $site_slogan;}?></a></h3>
	...
	<div id="hd">
						 ...
						 /*
						  ...
						  if ($site_slogan=strip_tags(variable_get('site_slogan',''))) {print "<h2>".$site_slogan."</h2>";}
