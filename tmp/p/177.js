...
/***/ "./node_modules/@ionic/pwa-elements/dist/esm/legacy/pwa-camera.entry.js":
/*!******************************************************************************!*\
  !*** ./node_modules/@ionic/pwa-elements/dist/esm/legacy/pwa-camera.entry.js ***!
  \******************************************************************************/
...
var CameraPWA = /** @class */ (function () {
    function CameraPWA(hostRef) {
        ...
        // Current flash mode
        this.flashMode = 'off';
        this.isServer = Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["i"])(this, "isServer");
    }
    CameraPWA.prototype.componentDidLoad = function () {
    ...
    CameraPWA.prototype.componentDidUnload = function () {
        this.stopStream();
        this.photoSrc && URL.revokeObjectURL(this.photoSrc);
    };
    CameraPWA.prototype.hasImageCapture = function () {
        return 'ImageCapture' in window;
    };
    /**
     * Query the list of connected devices and figure out how many video inputs we have.
     */
    CameraPWA.prototype.queryDevices = function () {
        return __awaiter(this, void 0, void 0, function () {
            var devices, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    CameraPWA.prototype.initCamera = function (constraints) {
        return __awaiter(this, void 0, void 0, function () {
            var stream, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    CameraPWA.prototype.initPhotoCapabilities = function (imageCapture) {
        return __awaiter(this, void 0, void 0, function () {
            var c;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    CameraPWA.prototype.stopStream = function () {
        this.stream && this.stream.getTracks().forEach(function (track) { return track.stop(); });
    };
    CameraPWA.prototype.capture = function () {
        return __awaiter(this, void 0, void 0, function () {
            var photo, e_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    CameraPWA.prototype.promptAccept = function (photo) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.photo = photo;
    ...
    CameraPWA.prototype.rotate = function () {
        this.stopStream();
    ...
    CameraPWA.prototype.setFlashMode = function (mode) {
        console.log('New flash mode: ', mode);
        this.flashMode = mode;
    };
    CameraPWA.prototype.cycleFlash = function () {
    ...
    CameraPWA.prototype.flashScreen = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
    ...
    CameraPWA.prototype.handleShutterClick = function (_e) {
        console.log();
        this.capture();
    };
    CameraPWA.prototype.handleRotateClick = function (_e) {
        this.rotate();
    };
    CameraPWA.prototype.handleClose = function (_e) {
        this.onPhoto && this.onPhoto(null);
    };
    CameraPWA.prototype.handleFlashClick = function (_e) {
        this.cycleFlash();
    };
    CameraPWA.prototype.handleCancelPhoto = function (_e) {
        this.photo = null;
    };
    CameraPWA.prototype.handleAcceptPhoto = function (_e) {
        this.onPhoto && this.onPhoto(this.photo);
    };
    CameraPWA.prototype.iconExit = function () {
    ...
    CameraPWA.prototype.iconConfirm = function () {
    ...
    CameraPWA.prototype.iconReverseCamera = function () {
    ...
    CameraPWA.prototype.iconRetake = function () {
    ...
    CameraPWA.prototype.iconFlashOff = function () {
    ...
    CameraPWA.prototype.iconFlashOn = function () {
    ...
    CameraPWA.prototype.iconFlashAuto = function () {
    ...
    CameraPWA.prototype.render = function () {
        var _this = this;
        var videoStreamStyle = this.facingMode == "user" ? { transform: 'scaleX(-1)' } : {};
        return (Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("div", { class: "camera-wrapper" }, Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("div", { class: "camera-header" }, Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("section", { class: "items" }, Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("div", { class: "item close", onClick: function (e) { return _this.handleClose(e); } }, Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("img", { src: this.iconExit() })), Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("div", { class: "item flash", onClick: function (e) { return _this.handleFlashClick(e); } }, this.flashModes.length > 0 && (Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("div", null, this.flashMode == 'off' ? Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("img", { src: this.iconFlashOff() }) : '', this.flashMode == 'auto' ? Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("img", { src: this.iconFlashAuto() }) : '', this.flashMode == 'flash' ? Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("img", { src: this.iconFlashOn() }) : ''))))), this.photo && (Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("div", { class: "accept" }, Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("div", { class: "accept-image", style: { backgroundImage: "url(" + this.photoSrc + ")" } }))), Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("div", { class: "camera-video", style: { display: this.photo ? 'none' : '' } }, this.showShutterOverlay && (Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("div", { class: "shutter-overlay" })), this.hasImageCapture() ? (Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("video", { style: videoStreamStyle, ref: function (el) { return _this.videoElement = el; }, autoplay: true, playsinline: true })) : (Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("canvas", { ref: function (el) { return _this.canvasElement = el; }, width: "100%", height: "100%" })), Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("canvas", { class: "offscreen-image-render", ref: function (e) { return _this.offscreenCanvas = e; }, width: "100%", height: "100%" })), Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("div", { class: "camera-footer" }, !this.photo ? ([
            Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("div", { class: "shutter", onClick: function (e) { return _this.handleShutterClick(e); } }, Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("div", { class: "shutter-button" })),
            Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("div", { class: "rotate", onClick: function (e) { return _this.handleRotateClick(e); } }, Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("img", { src: this.iconReverseCamera() })),
            { /*this.hasMultipleCameras && (<div class="item rotate" onClick={(e) => this.handleRotateClick(e)}></div>)*/}
        ]) : (Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("section", { class: "items" }, Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("div", { class: "item accept-cancel", onClick: function (e) { return _this.handleCancelPhoto(e); } }, Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("img", { src: this.iconRetake() })), Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("div", { class: "item accept-use", onClick: function (e) { return _this.handleAcceptPhoto(e); } }, Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["f"])("img", { src: this.iconConfirm() })))))));
    };
    Object.defineProperty(CameraPWA, "assetsDirs", {
        get: function () { return ["icons"]; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(CameraPWA.prototype, "el", {
        get: function () { return Object(_ionicpwaelements_51948158_js__WEBPACK_IMPORTED_MODULE_0__["g"])(this); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(CameraPWA, "style", {
